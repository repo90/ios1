...
$(document).ready(function () {
    ...
    $.getJSON("packages/" + dPackage + ".json", function (data) {
        ...
        var extra = {
            "<img class=\"icon\" src=\"icons/twitter.png\"><span>Find me on Twitter (ALBASRAWI)</span>": "https://twitter.com/alialbasrawi90",
            "<img class=\"icon\" src=\"icons/email.png\"><span>Send me an email</span>": "aliiosapp@gmail.com",
            "<img class=\"icon\" src=\"icons/like.png\"><span>Buy me a &#x1F37A; via <span style=\"font-style:italic;font-weight:bold;\"><span style=\"color:#253b80;\">Pay</span><span style=\"color:#419bd7;\">Pal</strong></span></span>": "https://paypal.me/"
        };
        $.extend(links, extra);
